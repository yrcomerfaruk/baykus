...
const getSupabase = ()=>{
    ...
    ;
    if (!supabaseInstance) {
        const supabaseUrl = ("TURBOPACK compile-time value", "https://lccsuvmymqpbcxnmywvn.supabase.co") || '';
        const supabaseAnonKey = ("TURBOPACK compile-time value", "sb_publishable_I7WKf09bYKTs1b61GYM3Ng_OqjjIIfq") || '';
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        supabaseInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl || 'https://placeholder.supabase.co', supabaseAnonKey || 'placeholder');
    }
...
//# sourceMappingURL=_0n-a80k._.js.map